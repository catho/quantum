...
<Canvas>
  <Story id="forms-checkbox-checkboxgroup--default" />
</Canvas>
...
<Canvas>
  <Story id="forms-checkbox-checkboxgroup--with-children" />
</Canvas>
...
<Canvas>
  <Story id="forms-checkbox-checkboxgroup--with-shared-error-message" />
</Canvas>

### Button Group

<Canvas>
  <Story id="forms-checkbox-checkboxgroup--button-group" />
</Canvas>

### Inline

<Canvas>
  <Story id="forms-checkbox-checkboxgroup--inline" />
</Canvas>
...
<Canvas>
  <Story id="forms-checkbox-checkboxgroup--controlled-group" />
</Canvas>