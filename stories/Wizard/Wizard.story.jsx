  ...
  <Heading name="Wizard">
    <TabbedView>
      <Tab title="Usage">
        ...
        <p>
          We provide two components to use Wizard: <code>{'<Wizard>'}</code> and{' '}
          <code>{'<Step title="Example">'}</code> must be used together.
        </p>
        <p>
          The <code>{'<Step>'}</code> must have a required title prop and his
          current status prop, that can be one of:
        </p>

        <ul>
          <li>
            <code>&nbsp;</code> <small>(empty string)</small>
          </li>
          <li>active</li>
          <li>done</li>
        </ul>
        ...
        <p>
          You can pass an icon to be displayed with the step component, see the
          example below:
        </p>
        <p>
