  ...
  <Card elevation={1} hoverElevation={5}>
    ...
    <Card.Container>
      ...
      <Card.SupportText>
        ...
        porttitor placerat. Vivamus nec purus sit amet elit condimentum
        malesuada.
      </Card.SupportText>
    </Card.Container>

    <Card.Container horizontal>
      <Card.Button skin="modal" type="button" onClick={() => {}}>
        Catho 1
      </Card.Button>
      ...
      <Tab title="Anatomy">
        <Row>
          <Col desktop={12} tablet={12}>
            <p>
              The card container is the only required element in a card. All
              other elements shown here are optional.
            </p>
            <p>
            ...
            >
              <Image
                src="https://material.io/design/assets/1eZNTdj8h1J0BFkbl23LyzEwjjvMzY_uV/cards-elements-2b.png"
                alt=""
                width="900"
              />
            </Col>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    ...
                    determined by the space those elements occupy. Card
                    elevation is expressed by the container.
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    Cards can include thumbnails to display an avatar, logo, or
                    icon.
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    Header text can include things like the name of a photo
                    album or article.
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    Cards can include a variety of media, including photos, and
                    graphics, such as weather icons.
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <code>{'<Card.SupportText />'}</code>
                  </td>
                  <td>
                    Supporting text include text like an article summary or a
            ...
            <p>
              Each card is made up of content blocks. All of the blocks, as a
              whole, are related to a single subject or destination. Content can
              receive different levels of emphasis, depending on its level of
              hierarchy.
            </p>
            ...
            >
              <img
                src="https://material.io/design/assets/0B6xUSjjSulxca3J1cWoxa003amc/cards-elements-1.png"
                alt=""
                width="900"
              />
            </Col>
            ...
            >
              <img
                src="https://material.io/design/assets/0B6xUSjjSulxcUTQtcVl0WURPWW8/cards-dividers-2.png"
                alt=""
                width="900"
              />
            </Col>
