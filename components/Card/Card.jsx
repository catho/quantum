...
const elevation = ({ elevation: level, hoverElevation: hoverLevel }) => {
  ...
  return `
    box-shadow: 0 ${elev * elev}px ${elev *
    elev *
    2}px rgba(0, 0, 0, 0.12), 0 ${elev}px ${elev * 2}px rgba(0, 0, 0, 0.24);

    ${hoverLevel &&
      `&:hover {
      box-shadow: 0 ${hovElev * hovElev}px ${hovElev *
        hovElev *
        2}px rgba(0, 0, 0, 0.12), 0 ${hovElev}px ${hovElev *
        2}px rgba(0, 0, 0, 0.24);
    }`}
  `;
};
